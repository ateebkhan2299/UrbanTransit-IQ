...
const TripManagement = () => {
    ...
    useEffect(() => {
        // Simulated fetch for Trips
        setItems([
            { id: 1, name: 'Sample Trips 1', status: 'Active' },
            { id: 2, name: 'Sample Trips 2', status: 'Inactive' }
        ]);
    }, []);
    ...
    return (
        <Box sx={{ p: 3 }}>
            <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 3 }}>
                <Typography variant="h4" fontWeight="bold">Manage Trips</Typography>
            ...
            <Modal open={openModal} onClose={() => setOpenModal(false)}>
                <Box sx={{ p: 4, bgcolor: 'background.paper', margin: '10% auto', width: 400, borderRadius: 2 }}>
                    <Typography variant="h6" mb={2}>Add/Edit Trips</Typography>
                    <Stack spacing={2}>
